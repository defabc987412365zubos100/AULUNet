...
class setting_config:
    ...
    model_config = {
        'num_classes': 1,
        'input_channels': 3,
        'c_list': [5,10,15,25,35,60]
    }

    datasets = 'ISIC2018' # here put the trained / test data folder_name
    if datasets == 'ISIC2017':
        ...
        raise Exception('dataset path not correct!!')

    print(f'Dataset: {datasets} Selected!!')
    print(f"c_list: {model_config['c_list']} Using!!")
